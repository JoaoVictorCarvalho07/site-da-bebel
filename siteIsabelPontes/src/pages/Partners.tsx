    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-[60vh] min-h-96 overflow-hidden bg-black">
        ...
        <div className="relative z-10 flex h-full items-end">
          <div className="mx-auto w-full max-w-6xl px-6 pb-20 text-white">
            <h1 className="text-5xl font-bold leading-tight">Parceiros & Colaboradores</h1>
            <p className="mt-4 text-lg text-white/90">
              Conheça os talentos incríveis que fazem parte do meu universo criativo
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        ...
        {selectedCategory && (
          <div className="mb-12 rounded-lg bg-gray-50 p-6">
            <h2 className="text-2xl font-bold text-black">{categoryLabels[selectedCategory]}</h2>
            <p className="mt-2 text-gray-700">
              {filteredPartners.length} {filteredPartners.length === 1 ? 'parceiro' : 'parceiros'}{' '}
              nesta categoria
            </p>
          </div>
        )}
        ...
        {filteredPartners.length === 0 && (
          <div className="text-center py-12">
            <p className="text-lg text-gray-600">Nenhum parceiro encontrado nesta categoria.</p>
          </div>
        )}
      </section>
      ...
      <section className="mt-16 bg-black py-16">
        <div className="mx-auto max-w-2xl px-6 text-center">
          ...
          <p className="mt-4 text-lg text-white/90">
            Estou sempre aberta para colaborações que tragam criatividade e autenticidade. Vamos
      ...
      {selectedCategory === null && (
        <section className="mx-auto max-w-6xl px-6 py-16">
          <h2 className="mb-8 text-3xl font-bold text-black">Parcerias Especiais</h2>
                ...
                <div key={partner.id} className="rounded-lg bg-gray-50 p-8">
                  <div className="mb-4 flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{categoryLabels[partner.category]}</p>
                    </div>
                  </div>
